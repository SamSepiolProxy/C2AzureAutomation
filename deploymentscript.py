...
def deployment():
    if args.IPWhitelist is None or args.resourcename is None:
        parser.error("--deployment requires -w and -r.")
...
def provision():
    ...
    os.system("terraform plan")
    os.system("terraform  apply -var-file='terraform.tfvars'")
    os.system("ANSIBLE_HOST_KEY_CHECKING=false ansible-playbook -u redteamuser -i '"+C2CovPublicIP+",' --private-key ./keys/id_rsa config/C2/mythic-setup.yaml")
